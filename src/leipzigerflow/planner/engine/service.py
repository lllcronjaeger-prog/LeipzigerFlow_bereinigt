...
class DispatchSimulationService:
    ...
    def _load_input(self, planning_day: date):
        ...
        orders = list(self.session.scalars(
            ...
            .where(~TransportOrder.id.in_(assigned_ids), TransportOrder.status.notin_(("Erledigt", "Storniert", "Extern vergeben")), TransportOrder.assignment_type != "Subunternehmer", TransportOrder.auto_dispatch_eligible.is_(True), TransportOrder.loading_date == planning_day)
